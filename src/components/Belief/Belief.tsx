    ...
    <>
      ...
      <div className="grid text-center justify-center gap-4 mt-6">
        ...
        <div className="flex justify-center my-4 relative">
          <StyledLine $rotate={-80} $top={"2rem"} $right={"17rem"}>
            |
          </StyledLine>
          <StyledLine $rotate={-30} $top={"0.5rem"} $right={"15rem"}>
            |
          </StyledLine>
          <StyledText>{mbti}</StyledText>
          <StyledLine $rotate={-30} $top={"8rem"} $left={"14rem"}>
            |
          </StyledLine>
          <StyledLine $rotate={-80} $top={"7rem"} $left={"16rem"}>
            |
          </StyledLine>
        </div>
...
const StyledLine = styled.div<{
  ...
  transform: ${({ $rotate }) =>
    $rotate ? `rotate(${$rotate}deg)` : "rotate(0)"};
